...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ mat.size()≤ 1000<br></span><span style="font-size: 18px;">1 ≤ mat[0].size() ≤ 1000<br>0 ≤ mat[i][j] ≤ 1000</span></p>