...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/toggle-case/1)

## Solved On
12 Aug 2026 at 08:22 am

<h2><a href="https://www.geeksforgeeks.org/problems/toggle-case/1">Toggle Case</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given a string <strong>s</strong>, <strong>convert </strong>the characters of the string into the <strong>opposite case</strong>, i.e., if a character is lowercase, then convert it into uppercase and vice versa.&nbsp;</span></p>
...
<p><span style="font-size: 18px;"><strong>Constraints:<br></strong></span><span style="font-size: 18px;">1 ≤ s.length() ≤ 10<sup>5</sup></span></p>